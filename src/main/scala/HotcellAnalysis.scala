...
object HotcellAnalysis {
  ...
  Logger.getLogger("com").setLevel(Level.WARN)
    ...
    //To calculate average of hotness of cells
    ...
    //To get all the adjacent hot cells count by comparing the x,y,z coordinates
    ...
    //To calculate G Score for every cell, order the data frame by GScore in descending order and keep only first 50 cells
